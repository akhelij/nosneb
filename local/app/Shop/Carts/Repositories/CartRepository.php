...
class CartRepository extends BaseRepository implements CartRepositoryInterface
{
     ...
     * @return CartItem
     */
    public function addToCart(Product $product, float $size, int $int, $options = []) : CartItem
    {
        
        return $this->model->add($product, $size,$int, $options);
    }
    ...
    {
        return str_replace(",","",$this->model->subtotal(2));
    }
     ...
     * @return float
     */
    public function getTotal(int $decimals = 0, $shipping = 0.00,$method = null,$converted = null)
    {
        return floatval(str_replace(",","",$this->model->total($decimals, null, null, $shipping,$method,$converted)));
    }
    ...
    {
        return number_format($courier->cost, 0);
    }
