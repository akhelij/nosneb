...
class OrderRepository extends BaseRepository implements OrderRepositoryInterface
{
     ...
     * @param int $quantity
     */
    public function associateProduct(Order $order, Product $product, float $size = null, int $quantity = 1)
    {

        $this->model->products()->attach($product, ['quantity' => $quantity, 'size' => $size]);
