				...
				<form action="{{ route('customer.address.store', $customer->id) }}" method="post" class="form" enctype="multipart/form-data">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<select name="country_id" id="country_id" country_id="" class="form-control "></select>
						</div>
						<div class="form-group">
							<label for="province">Région </label>
						
							<select  name="province_id" id="province_id"  province_id ="" class="form-control "></select>
						</div>
						<div class="form-group">
							<label for="city">Ville </label>
						
							<select  name="city_id" id="city_id" city_id="" class="form-control "></select>
						</div>
