            ...
            <div class="box-header">
                <div class="row">
                    ...
                    <div class="col-md-3 col-md-offset-3">
                        @if($currentStatus->name != "DECLINED")
            ...
            <div class="box-body">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-info btn-block" style="background-color:{{ $currentStatus->color }}">{{ $currentStatus->name }}</button></td>
                                 @if($currentStatus->id == 6)
                                    <td>
                                        <form action="{{ url('admin04081994/orders/'. $order->id) }}" method="post" >
                                            {{ method_field('PUT') }}
                                            {{ csrf_field() }}
                                            
                                            <input type="submit" class="btn btn-danger " value="REVERSE">
                                        </form>
                                    </td>
                                    @endif
                    </tr>
        ...
        @if($order)
            @if($order->total != $order->total_paid)
                <p class="alert alert-danger">
                    ...
                    Total order amount: <strong> {{ $order->total }} MAD</strong> <br>
                    Total amount paid <strong> {{ $order->total_paid }} MAD</strong>
                </p>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $order->address->city_id }}</td>
                                    <td>{{ $order->address->province_id }}</td>
